        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-gray-900/70 backdrop-blur-sm p-8 rounded-2xl border border-gray-800 shadow-xl">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-cyan-400 to-blue-400">
                Welcome Back
              </h1>
              <p className="text-gray-400 mt-2">Log in to your EducatorAI account</p>
            </div>
